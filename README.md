...
Setting `OTEL_EXPORTER_OTLP_ENDPOINT` is sufficient to enable all three signals (traces, metrics, logs) over gRPC. See the [Observability](#observability) section for the full env var reference.
